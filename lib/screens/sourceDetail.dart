...
import 'package:flutter_application_1/screens/newsDetail.dart';
import 'package:flutter_application_1/theme.dart';
import '../components/loader.dart';
import '../models/article.dart';
import '../models/articleResponse.dart';
import '../models/source.dart';
import '../shared/getSourceNews.dart';
...
class _SourceDetailState extends State<SourceDetail> {
  ...
  void initState() {
    super.initState();
    getSourceNews..getSourceNews(source.id);
  }

  @override
  void dispose() {
    getSourceNews.drainStream();
    super.dispose();
  }
        ...
        body: Column(
          children: [
            ...
            Expanded(
              ...
              stream: getSourceNews.subject.stream,
